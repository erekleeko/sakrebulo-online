...
// ტესტირების ექაუნთები (მომავალში ბაზიდან ამოვიღებთ)
...
// ============================================
// --- აპარატის (ადმინის) მართვის ლოგიკა ---
// ============================================
function initAdmin() {
        ...
        snapshot.forEach(docSnap => {
            ...
            htmlContent += `
                <div class="issue-card">
                    <h3>${data.title} <span class="status-badge ${badgeClass}">${statusText}</span></h3>
                    
                    <div class="live-stats" id="stats-${id}">
                        <div style="width: 100%; text-align: center; color: #666; padding: 20px;">⏳ სტატისტიკა იტვირთება...</div>
                    </div>
